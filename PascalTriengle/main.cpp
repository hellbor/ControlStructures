...
void main()
{
	...
	for (int i = 0; i < h; i++)
	{
		...
		// Если выводимое значение занимает больше позиций, то оно выйдет за пределы указанной ширины.
		cout << ""; //Даже при выводе пустой строки, она займет всю заданную ширину (цшвер/2)
	}
	cout << left;
	cout << 1 << endl;
	DataType nf = 1;
